...
plugins {
    alias(libs.plugins.kotlin.v212)
    alias(libs.plugins.intellij.v212)

    antlr
}

version = rootProject.version as String + ".212"
...
intellij {
    ...
    version(libs.versions.ide.v212)
    downloadSources(!isCI)
    sandboxDir("${project.rootDir.absolutePath}/.sandbox.v212")
