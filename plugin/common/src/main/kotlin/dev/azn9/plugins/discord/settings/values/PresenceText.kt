...
enum class PresenceText(override val text: String, override val description: String? = null) : RenderedValue<PresenceText.Result>, UiValueType {
    ...
    companion object {
        ...
        val Project1 =
            PROJECT_NAME to arrayOf(NONE, APPLICATION_VERSION, APPLICATION_NAME, PROJECT_DESCRIPTION, PROJECT_NAME, PROJECT_NAME_DESCRIPTION, PROJECT_VCS_BRANCH, PROJECT_NAME_VCS_BRANCH, CUSTOM)
        val Project2 = PROJECT_DESCRIPTION to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
        ...
        val ProjectIconLarge = APPLICATION_VERSION to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
        ...
        val ProjectIconSmall =
            NONE to arrayOf(NONE, APPLICATION_VERSION, APPLICATION_NAME, PROJECT_DESCRIPTION, PROJECT_NAME, PROJECT_NAME_DESCRIPTION, PROJECT_VCS_BRANCH, PROJECT_NAME_VCS_BRANCH, CUSTOM)
        val File1 = PROJECT_NAME_DESCRIPTION to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
        ...
        val File2 = FILE_NAME_PATH to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
        ...
        val FileIconLarge = FILE_LANGUAGE to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
        ...
        val FileIconSmall = APPLICATION_VERSION to arrayOf(
            NONE,
            APPLICATION_VERSION,
            APPLICATION_NAME,
            PROJECT_DESCRIPTION,
