...
import dev.azn9.plugins.discord.utils.Color.blurple
import dev.azn9.plugins.discord.utils.Color.darkOverlay
import dev.azn9.plugins.discord.utils.Color.green
import dev.azn9.plugins.discord.utils.Color.greenTranslucent
import dev.azn9.plugins.discord.utils.Color.whiteTranslucent60
import dev.azn9.plugins.discord.utils.Color.whiteTranslucent80
...
import dev.azn9.plugins.discord.rpc.User as RPCUser
...
class PreviewRenderer {
    ...
    suspend fun draw(type: Renderer.Type.Application, force: Boolean = false): ModifiedImage {
        val data = Data.None.completeMissingData()
