...
plugins {
    alias(libs.plugins.kotlin.v223)
    alias(libs.plugins.intellij.v223)

    antlr
}

version = rootProject.version as String + ".223"
...
intellij {
    ...
    version(libs.versions.ide.v223)
    downloadSources(System.getenv("CI") == null)
    sandboxDir("${project.rootDir.absolutePath}/.sandbox.v223")
